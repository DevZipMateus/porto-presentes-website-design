      ...
      <main className="pt-20">
        ...
        <section className="bg-gray-50 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">Conheça nossa linha completa de souvenirs e presentes personalizados. Produtos de qualidade, para informação sobre preço clique no botão abaixo da imagem escolhida.</p>
          </div>
        </section>
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {products.map(product => <div key={product.id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                  <div className="w-full h-64 sm:h-72 md:h-80 overflow-hidden bg-gray-50 p-4">
                    <img src={product.image} alt={product.title} className="w-full h-full object-contain hover:scale-105 transition-transform duration-300" loading="lazy" />
                  </div>
                  ...
                  <div className="p-6">
                    ...
                    <button onClick={handleContactClick} className="w-full bg-gray-900 text-white py-3 px-4 sm:px-6 rounded-lg hover:bg-gray-800 transition-colors duration-300 font-medium text-sm sm:text-base">
        ...
        <section className="bg-gray-900 text-white py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <button onClick={handleContactClick} className="bg-white text-gray-900 py-4 px-8 rounded-lg hover:bg-gray-100 transition-colors duration-300 font-semibold text-lg">
