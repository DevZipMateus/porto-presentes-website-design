export const Services = () => {
  ...
  const services = [{
    ...
    icon: "🛍️",
    features: ["Produtos regionais autênticos", "Qualidade garantida", "Variedade de categorias", "Preços competitivos"]
  }, {
    ...
    icon: "🎨",
    features: ["Logotipos personalizados", "Cores exclusivas", "Design sob medida", "Aprovação prévia"]
  }, {
    title: "Desenvolvimento de Artes Temáticas",
    description: "Criamos artes exclusivas com o tema desejado pelo cliente",
    icon: "✨",
    features: ["Equipe criativa especializada", "Temas regionais", "Arte original", "Múltiplas aplicações"]
  }];
  return <section id="servicos" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {services.map((service, index) => <div key={index} className="bg-gray-50 rounded-2xl p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <div className="space-y-3">
                {service.features.map((feature, featureIndex) => <div key={featureIndex} className="flex items-center text-gray-700">
              ...
              <div className="mt-8 text-center">
                <button onClick={handleQuoteClick} className="bg-gray-900 text-white px-6 py-3 rounded-lg hover:bg-gray-800 transition-colors duration-300 w-full font-medium" aria-label={`Solicitar orçamento para ${service.title}`}>
                  Solicitar Orçamento
                </button>
              </div>
            </div>)}
        ...
        <div className="mt-16 text-white rounded-2xl p-12 text-center bg-zinc-700">
