      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Conheça nossa linha completa de souvenirs e canecas temáticas regionais
          </p>
        </div>
                  ...
                  <div className="relative aspect-square md:aspect-[4/3] lg:aspect-[16/10]">
                    ...
                    <div className="absolute inset-0 bg-black bg-opacity-20 flex items-end">
                      <div className="p-6 text-white w-full">
                        <h3 className="text-lg md:text-xl font-semibold bg-black bg-opacity-60 p-3 rounded-lg">
                          {product.title}
                        </h3>
                      </div>
                    </div>
        ...
        <div className="text-center mt-12">
          <a 
            href="/catalogo" 
            className="inline-block bg-gray-900 text-white px-8 py-4 rounded-lg hover:bg-gray-800 transition-colors duration-300 font-semibold text-lg"
          >
